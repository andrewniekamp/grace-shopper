...
export const reviews = (props) => {
  console.log('allReviews perhaps? ', props);
  return (<div className="container">
      <div className="row">
        <div className="col-md-2">
          <img src="https://memegenerator.net/img/images/600x600/2154021/not-bad-obama.jpg" className="img-rounded" height="50px" />
          <h5>
            <a href="#">Obama</a>
          </h5>
          <p>
        ...
        <div className="col-md-2">
          ...
          <p>No hangover {props.allReviews}</p>
        </div>
      </div>
    </div>);
};
